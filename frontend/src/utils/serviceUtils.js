export const getCategoryThumbnail = (categoryName) => {
  const defaults = {
    ...
    'Painting': 'https://images.unsplash.com/photo-1589939705384-5185138a04b9?w=800&q=80',
    ...
    'Massage Therapy': 'https://images.unsplash.com/photo-1600334089648-b0d9d3028eb2?w=800&q=80',
