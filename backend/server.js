...
app.use((req, res, next) => {
  ...
  if (origin && (allowedOrigins.includes(origin) || origin.includes('vercel.app') || origin.includes('localhost'))) {
    ...
    // For non-browser requests (mobile/curl)
...
// Also use cors package for extra compatibility but with simpler config
app.use(cors({
  origin: true, // Allow all origins (we filter manually above for security)
  credentials: true
}));
